...
Using the summary of the model, the estimated concentration of each type of drugs is :

Isofluorane : 43.40%

Halothane : 3.50 % (The way the linear model adjusted itself, this parameter has p-value\> 0.81. This means the estimator considers its effect insignificant on the concentration of plasma.)
